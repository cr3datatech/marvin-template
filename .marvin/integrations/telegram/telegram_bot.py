...
Create a **subpage** under the main Confluence page using `create_confluence_page` with the main page's ID as `parent_id`. Title the subpage `LinkedIn Post — [Idea Name]`. Write the full post as the page content. Then paste the post directly in Slack/Telegram for easy copy. Format:
